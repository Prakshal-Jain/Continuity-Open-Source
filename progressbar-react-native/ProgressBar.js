...
export default function ProgressBar({ stepCount = 1, currStep = 0, colorScheme = 'light' }) {
                ...
                if ((idx + 1) < currStep) {
                    ...
                    return (
                        <LinearGradient
                            ...
                            colors={[(colorScheme === 'dark') ? 'rgba(10, 132, 255, 1)' : 'rgba(0, 122, 255, 1)', (colorScheme === 'dark') ? 'rgba(10, 132, 255, 0.3)' : 'rgba(0, 122, 255, 0.3)', (colorScheme === 'dark') ? 'rgba(10, 132, 255, 0)' : 'rgba(0, 122, 255, 0)']}
                            start={[0, 0]} end={[1, 0]}
                        >
                        </LinearGradient>
                    )
